...
This module gives one admitted target file—``pyproject.toml``—its narrow meaning for
the B2 target-relevance slice. It parses only ``[project].requires-python`` and
preserves unavailable, malformed, missing, and invalid states explicitly.
"""
