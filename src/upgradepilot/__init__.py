...
``dependency_change.py``, ``exact_requirement_change.py``, and ``pypi_client.py``.
Re-exporting selected contracts lets callers use stable package-level imports without
