...
This module owns only behavior that is identical for PyPI's release and Integrity
APIs: request configuration, streamed body limits, response closing, and JSON-object
decoding. Endpoint-specific clients retain HTTP-status meaning and evidence states.
"""
...
class PyPIJsonApiClient:
    ...
    def _get_response(self, url: str, *, resource: str) -> Response:
        """Send one streamed GET without assigning endpoint-specific status meaning."""
