"""Acquire a published GitHub Release bound to one exact Git tag reference."""
...
from .tag import parse_exact_tag_reference
...
class GitHubReleaseProblem:
    """Why an exact published GitHub release could not be established."""
...
class GitHubReleaseClient(GitHubApiClient):
    """Read published release and tag-ref evidence for a public repository."""
