...
- `test_pypi_client.py` — exact PyPI package/version identity, normalization, bounded responses, and explicit failure states.
...
The tests prove only their bounded deterministic claims. They do not prove live PyPI
availability, official authority for publisher-supplied project links, release compatibility,
broad YAML support, complete CI coverage, upgrade safety, or a correct maintainer
recommendation.
